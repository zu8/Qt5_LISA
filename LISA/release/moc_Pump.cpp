...
QT_MOC_LITERAL(1, 5, 8), // "PumpMove"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 4), // "flag"
QT_MOC_LITERAL(4, 20, 11) // "PumpClicked"

    },
    "Pump\0PumpMove\0\0flag\0PumpClicked"
};
...
void Pump::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PumpMove((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->PumpClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Pump::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pump::PumpMove)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Pump::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pump::PumpClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Pump::PumpClicked(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
