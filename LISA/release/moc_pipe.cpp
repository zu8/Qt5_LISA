...
QT_MOC_LITERAL(1, 5, 13), // "finishDrawing"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10), // "Pipelength"
QT_MOC_LITERAL(4, 31, 9), // "rectScene"
QT_MOC_LITERAL(5, 41, 3) // "scR"

    },
    "pipe\0finishDrawing\0\0Pipelength\0rectScene\0"
    "scR"
};
...
void pipe::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finishDrawing((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 1: _t->rectScene((*reinterpret_cast< QRectF(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (pipe::*)(qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pipe::finishDrawing)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void pipe::finishDrawing(qreal _t1)
{
