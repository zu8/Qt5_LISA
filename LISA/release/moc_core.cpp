...
QT_MOC_LITERAL(1, 5, 16), // "SprinklerClicked"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10), // "Sprinkler*"
QT_MOC_LITERAL(4, 34, 10) // "coremoving"

    },
    "Core\0SprinklerClicked\0\0Sprinkler*\0"
    "coremoving"
};
...
void Core::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->coremoving((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Core::*)(Sprinkler * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Core::SprinklerClicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Core::coremoving)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Core::SprinklerClicked(Sprinkler * _t1)
{
